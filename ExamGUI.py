...
class Ui_ExamWindow(object):
    ...
    def setupUi(self, ExamWindow, firstname, lastname):
        ExamWindow.setObjectName("ExamWindow")
        ExamWindow.resize(492, 292)
        ...
        self.Label_WelcomeUser.setText("Welcome " + firstname + " " + lastname + "!")
    ...
    def retranslateUi(self, ExamWindow):
        ...
        self.pushButton_SignOut.hide()
        self.pushButton_AddFruit.hide()
        
        
    def StartQuiz(self):
        
        self.ExamBL.SetScore(0)
        self.ExamBL.SetQuestionCurrent(1)
        self.ExamBL.RandomPictureInData()
        
        # (QtCore.QRect(140, 60, 171, 121))
        path = QPixmap("C:\\FruitExam\\fruit.jpg")
        path2 = path.scaled(171, 121)
        
        self.Label_Picture.show()
        self.Label_Picture.setPixmap(path2)
    ...
    def SubmitAnswer(self):
        ...
        self.ExamBL.SetAnswer(self.lineEdit_Answer.text())
        self.ExamBL.SetIsAnswerCorrect(False)

        if self.ExamBL.IsAnswerBlank(self.lineEdit_Answer.text()):
            self.Label_QuizStatus.setText("Your answer is blank!")
            self.Label_QuizStatus.setStyleSheet("color: red;")

        elif self.ExamBL.IsAnswerInChoices(self.lineEdit_Answer.text()):
            if self.ExamBL.IsAnswerCorrect(self.lineEdit_Answer.text()):
                self.ExamBL.AddScore()
                self.ExamBL.SetIsAnswerCorrect(True)
                
            if self.ExamBL.GetQuestionCurrent() == 1:
                if self.ExamBL.GetIsAnswerCorrect():
                    self.Label_Question1Ans.setStyleSheet("color: green;")
                else:
                    self.Label_Question1Ans.setStyleSheet("color: red;")
                self.Label_Question1Ans.setText("Question 1: " + self.ExamBL.GetAnswer())
                
            elif self.ExamBL.GetQuestionCurrent() == 2:
                if self.ExamBL.GetIsAnswerCorrect():
                    self.Label_Question2Ans.setStyleSheet("color: green;")
                else:
                    self.Label_Question2Ans.setStyleSheet("color: red;")
                self.Label_Question2Ans.setText("Question 2: " + self.ExamBL.GetAnswer())
                
            elif self.ExamBL.GetQuestionCurrent() == 3:
                if self.ExamBL.GetIsAnswerCorrect():
                    self.Label_Question3Ans.setStyleSheet("color: green;")
                else:
                    self.Label_Question3Ans.setStyleSheet("color: red;")
                self.Label_Question3Ans.setText("Question 3: " + self.ExamBL.GetAnswer())
                
            elif self.ExamBL.GetQuestionCurrent() == 4:
                if self.ExamBL.GetIsAnswerCorrect():
                    self.Label_Question4Ans.setStyleSheet("color: green;")
                else:
                    self.Label_Question4Ans.setStyleSheet("color: red;")
                self.Label_Question4Ans.setText("Question 4: " + self.ExamBL.GetAnswer())
                    
            elif self.ExamBL.GetQuestionCurrent() == 5:
                if self.ExamBL.GetIsAnswerCorrect():
                    self.Label_Question5Ans.setStyleSheet("color: green;")
                else:
                    self.Label_Question5Ans.setStyleSheet("color: red;")
                self.Label_Question5Ans.setText("Question 5: " + self.ExamBL.GetAnswer())
                    
            
            if self.ExamBL.GetQuestionCurrent() >= 5:
                
                self.Label_ScoreCurrent.setText(str(self.ExamBL.GetScore()))
                ...
                self.ExamBL.SetIsAnswerCorrect(False) 
                self.Label_QuestionCurrent.setText(str(self.ExamBL.AddQuestionCurrent()))   
...
if __name__ == "__main__":
    ...
    ui = Ui_ExamWindow()
    ui.setupUi(ExamWindow, firstname = "Ronald", lastname = "Magbitang")
    ExamWindow.show()
    sys.exit(app.exec_())
